...
import com.li.usercenter.model.domain.request.UserLoginRequest;
import com.li.usercenter.model.domain.request.UserRegisterRequest;
...
public class UserController {
    ...
    public BaseResponse<List<User>> searchUserBYTags(@RequestBody(required = false) List<String> tagNameList)
    {
    ...
    @GetMapping("/recommend")   //查的是全部的用户
    public BaseResponse<Page<User>> recommendUsers(long pageSize,long pageNum,HttpServletRequest request)
    {
        User loginUser = userService.getloginUser(request);
        String redisKey =String.format("li:user:recommend:%s",loginUser.getId());
